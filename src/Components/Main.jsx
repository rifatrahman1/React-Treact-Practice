    ...
    return (
        <div className="flex items-center justify-between mt-48">
            ...
            <div className='text-left'>
                ...
                <h1 className="text-5xl font-extrabold leading-snug mt-6">We've been serving <br /> for <span className="australia text-[#6315ff] leading-snug px-4 rounded-t-3xl mt-14">over 5 years.</span></h1>
                ...
                <p className='text-[#8d8988] font-semibold mt-10'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris <br /> nisi ut aliquip ex ea commodo consequat.</p>
