...
const Treact_App = () => {
    return (
        <div className="bg-[#1a202c] mt-24 lg:px-0 px-4">
            <div className="flex lg:flex-row flex-col-reverse items-center justify-center gap-24 py-24">
                <div className='lg:text-left text-center'>
                    <h3 className='inter text-[#deb170] font-bold'>Download App</h3>
                    <h1 className="text-3xl inter lg:text-left font-extrabold leading-snug mt-4 text-white">People around you are ordering delicious <br /> meals using the <span className="australia text-[#6315ff] bg-white leading-loose px-4 mt-14">Treact App.</span></h1>
